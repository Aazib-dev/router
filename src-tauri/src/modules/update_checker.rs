...
const GITHUB_API_URL: &str =
    "https://api.github.com/repos/Aazib-Ai/router/releases/latest";
const GITHUB_RAW_URL: &str =
    "https://raw.githubusercontent.com/Aazib-Ai/router/main/package.json";
const JSDELIVR_URL: &str =
    "https://cdn.jsdelivr.net/gh/Aazib-Ai/router@main/package.json";
...
const UPDATER_JSON_URL: &str =
    "https://github.com/Aazib-Ai/router/releases/latest/download/updater.json";
...
async fn check_updater_json() -> Result<UpdateInfo, String> {
    ...
    let download_url = format!(
        "https://github.com/Aazib-Ai/router/releases/tag/v{}",
        latest_version
    );
...
async fn check_static_url(url: &str, source_name: &str) -> Result<UpdateInfo, String> {
    ...
    let download_url = "https://github.com/Aazib-Ai/router/releases/latest".to_string();
