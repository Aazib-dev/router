...
fn format_switch_refresh_error(message: &str) -> String {
    ...
    {
        return format!(
            "Token refresh failed: OAuth client is not authorized for this account. Please sign in again in the application and complete authorization/verification. Raw error: {}",
            message
        );
    }
